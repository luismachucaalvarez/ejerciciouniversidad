		  ...
		  <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
			<div class="card border-0 shadow rounded-3 my-5">
			  <div class="card-body p-4 p-sm-5">
				<h5 class="card-title text-center mb-5 fw-light fs-5">Ingreso nuevo investigador</h5>
				<div class="form-floating mb-3">
					<form:form action="/guardarInvestigador" method="post" modelAttribute="investigador">
					<form:hidden path="id" />
					...
					<form:select class="form-control" path="facultad">
						<form:option value="none">--Favor asignar facultad--</form:option>
							<form:options items="${listaFacultades }" itemLabel="nombre" itemValue="id"></form:options>
						</form:select>
				</div>
				  <div class="d-grid">
					  <form:button class="btn btn-primary btn-login text-uppercase fw-bold" id="agregar-investigador">Agregar</form:button>
					</form:form>
